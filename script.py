...
try:
	...
	for college_code in college:
		...
		for branch_code in branch:
			...
			layout = Layout(
						title=college_name+' 3rd Sem '+branch_code+' Frequency of Total Marks',
						xaxis=XAxis(
		    				title='Total Marks',
		    			),
		    			yaxis = YAxis(
			...
			unique_url = py.plot(fig, filename = college_name+' 3rd Sem '+branch_code+' Frequency of Total Marks') 
